    ...
    <>
      <Item.Content verticalAlign="middle" className="cart-item">
        ...
        <div className="quanity-group">
          ...
          <Input className="input-quanity" value={itemQuantity} />
          <Button
            positive
            className="quan-buttons"
            onClick={() => {
